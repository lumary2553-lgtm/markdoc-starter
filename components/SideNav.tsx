...
const items: NavSection[] = [
  {
    ...
    links: [
      ...
      {href: 'APIs/MGAClaimsPublicAPI', children: 'MGA Claims Public API'}, {href: 'APIs/MGAClaimsvNextAzureFunction', children: 'MGA Claims vNext Azure Function'},{href: 'APIs/MGAPracticesAPI', children: 'MGA Practices API'}, {href: 'APIs/MGACustomersMetadata', children: 'MGA Customers Metadata'}, {href: 'APIs/MGACustomersPII', children: 'MGA Customers PII'}, {href: 'APIs/OnboardingToolAPI', children: 'Onboarding Tool API'}, {href: 'APIs/PracticeLoaderAzureFunction', children: 'Practice Loader Azure Function'}, {href: 'APIs/CaladanFileProcessor', children: 'Caladan File Processor'}, {href: 'APIs/MGAOnboardingAPI', children: 'MGA Onboarding API'}, {href: 'APIs/CaladanFileDataExtractor', children: 'Caladan File Data Extractor'}, {href: 'APIs/CaladanFileMetadata', children: 'Caladan File Metadata'}, {href: 'APIs/CaladanWebRequests', children: 'Caladan Web Requests'}, {href: 'APIs/ClarusTechMGAInvoicesAPIGateway', children: 'Clarus Tech MGA Invoices API Gateway'}, {href: 'APIs/ClarusTechMGAInvoicesInvoiceProcessor', children: 'Clarus Tech MGA Invoices Invoice Processor'}, {href: 'APIs/ClarusTechMGAInvoicesWebHook', children: 'Clarus Tech MGA Invoices Web Hook'}, {href: 'APIs/CCHPIMSDataLoader', children: 'CCH PIMS Data Loader'}, {href: 'APIs/CCHPIMSDataEncryptor', children: 'CCH PIMS Data Encryptor'}, {href: 'APIs/CCHPIMSInvoiceSearch', children: 'CCH PIMS Invoice Search'}, {href: 'APIs/CCHPIMSPolicy', children: 'CCH PIMS Policy'}, {href: 'APIs/CCHPIMSInvoiceOnDemand', children: 'CCH PIMS Invoice On Demand'}, 
    ],
  },
